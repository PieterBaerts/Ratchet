...
or to be more precise average steady state density for single head \eqref{eq:eff_distribution}.  
...
the motor head is very unlikely to cross the potential barrier in the attached state. 
