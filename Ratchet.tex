...
\caption{Mean velocity of the motor relative to the actin filament for $c \in (0,1)$.
...
\caption{Mean velocity of the motor relative to the actin filament for varying $k_{a}$.
...
\caption{The mean velocity of the motor $\langle v \rangle$ with a small load force $F_load$ against the direction of the ratchet is plotted for different detach rates.}
\label{Fig: F_v_zoom} 
\end{figure}
...
\caption{Mean velocity of the motor against the load force for $c=0.3$.}
\label{Fig: F_v} 
\end{figure}
