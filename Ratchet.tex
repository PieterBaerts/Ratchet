...
In this setup the motor is interacting with two anti-parallel actin filaments. 
However, now the filaments are directly subjected to an external load.
...
&\begin{multlined}[b]
\rmd x_\text{M} = \\
- \frac{1}{\gamma_\text{M}} \left[ \nabla_\text{M} V_t(x_\text{M}(t) - x_\text{A1}(t)) + \nabla_\text{M} V_t(x_\text{M}(t) - x_\text{A2}(t)) \right] \; \rmd t 
\\ 
+ \sqrt{ \frac{2 k_B T}{\gamma_\text{M}} } \; \rmd W_\text{M} ,
\end{multlined}\\
&\begin{multlined}[b][.42\textwidth]
...
&\begin{multlined}[b][.42\textwidth]
\rmd x_\text{A2} = 
\frac{1}{\gamma_\text{A}} \left[ - \nabla_\text{A1} V_t(x_\text{M}(t) - x_\text{A2}(t)) - F_\text{load} \right] \; \rmd t 
\\
...
Here, we will look at the motor in a setup where it is subjected to different stiffnesses of the environment in which the filaments are able to move. 
...
&\begin{multlined}[b][.42\textwidth]
\rmd x_\text{A1} = \\
\frac{1}{\gamma_\text{A}} \left[ - \nabla_\text{A1} V_t(x_\text{M}(t) - x_\text{A1}(t)) - k\left(x_\text{A1}(t) - x_\text{A1}(0)\right) \right] \; \rmd t 
\\
+ \sqrt{ \frac{2 k_B T}{\gamma_\text{A}} } \; \rmd W_\text{A1} ,
\end{multlined}\\
&\begin{multlined}[b][.42\textwidth]
\rmd x_\text{A2} = \\
\frac{1}{\gamma_\text{A}} \left[ - \nabla_\text{A1} V_t(x_\text{M}(t) - x_\text{A2}(t)) - k\left(x_\text{A2}(t) - x_\text{A2}(0)\right) \right] \; \rmd t 
\\
+ \sqrt{ \frac{2 k_B T}{\gamma_\text{A}} } \; \rmd W_\text{A2}
\end{multlined}
\end{align*}
...
The motor is again interacting with two filament that are arranged in an anti-parallel fashion. 
