...
This leads to an increase of $\eta$, see figures~\ref{fig:chem} and \ref{fig:chem_energy_distr}. 

For a load in the opposite direction $F_\text{load}= -25 \, \mathrm{pN}$ the effect on $\eta$ is similar but less pronounced, 
figure~\ref{fig:chem_energy_distr}, 
...
Hence, it is more plausible to find a head in the ATP bound state around the potential minimum. 
