...
\begin{align}
\langle v_\text{A1} \rangle &= \frac{1}{\gamma_\text{A} } \left( -F_\text{load} - F_\text{r1} \right) \\
\langle v_\text{M} \rangle &= \frac{1}{\gamma_\text{M} } \left( F_\text{r1} + F_\text{r2} \right)\\
\langle v_\text{A2} \rangle &= \frac{1}{ \gamma_\text{A} } \left( F_\text{load} - F_\text{r2}  \right) 
\end{align}
