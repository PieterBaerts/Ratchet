...
We use an Euler-Maruyama integration scheme to stochastically evolve the systems from a randomised initial configuration \cite{kloeden1989survey,maruyama1955continuous}. Results are obtained after both ergodic and ensemble averaging, up to a minimal time of $1s$ and over $100$ or more independent copies.    
