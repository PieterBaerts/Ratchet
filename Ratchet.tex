...
\end{equation}
The tension on the motor is shown in figure \ref{fig:tug_F}, where it is compared to the tension when the load is applied on the motor instead of the filaments, like in section \ref{sec:force-velocity}. There the tension can be derived from equations \eqref{pre_velocity_M},\eqref{pre_velocity_A}, \eqref{velocity_M} and \eqref{velocity_A}.
\begin{align}
