...
plot [-100:100][-150:150] \
    ...
    , "Data/F_q_k=4.dat" u 1:2:3 w errorlines ls 6 lw 1.25 dashtype 4 title "k_{bind}/k_{unbind} = 1" \
    , "Data/F_q_k=8.dat" u 1:2:3 w errorlines ls 8 lw 1.25 dashtype 5 title "k_{bind}/k_{unbind} = 2" \
    , "Data/F_q_k=16.dat" u 1:2:3 w errorlines ls 10 lw 1.25 dashtype 6 title "k_{bind}/k_{unbind} = 4" \
