...
plot [-20:20] \
      "Data/F_q_k=8.dat" u ( ( (2.*gamma_A + gamma_M)*$1 + gamma_A*gamma_M*$2)/(gamma_A + gamma_M)):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w errorlines ls 3 pt 2 dashtype 1 t "Load on motor" \
    , "Data/F_q_fil.dat" u ( (-gamma_M/(gamma_A+gamma_M)*($2*gamma_A+$1))):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w errorlines ls 6 pt 4 dashtype 2 t "Load on polymer" \
    , "Data/tug_F.dat" u (-($2-$4)*gamma_A-2.*$1):(1+$9/$8):(sqrt($11**2/$8**2+$9**2/$8**4*$10**2)) w errorlines ls 8 pt 6 dashtype 4 t "Tug of war" \
    , "Data/tug_k_E.dat" u (-($2-$4)*$1):(1+$9/$8):(sqrt($11**2/$8**2+$9**2/$8**4*$10**2)) w errorlines ls 10 pt 8 dashtype 5 t "Elastic environment" \
