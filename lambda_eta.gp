...
plot [-20:20][-0.1:0.3] \
      "Data/F_q_k=1.dat" u ( ( gamma_A*$1 + gamma_A*gamma_M*$2)/(gamma_A + gamma_M)):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w linespoints ls 1 lw 1.25 dashtype 1 title "{/Symbol l}_{b}/{/Symbol l}_{u} = 0.25" \
    , "Data/F_q_k=2.dat" u ( ( gamma_A*$1 + gamma_A*gamma_M*$2)/(gamma_A + gamma_M)):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w linespoints ls 3 lw 1.25 pt 2 dashtype 2 title "{/Symbol l}_{b}/{/Symbol l}_{u} = 0.5" \
    , "Data/F_q_k=4.dat" u ( ( gamma_A*$1 + gamma_A*gamma_M*$2)/(gamma_A + gamma_M)):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w linespoints ls 6 lw 1.25 pt 4 dashtype 4 title "{/Symbol l}_{b}/{/Symbol l}_{u} = 1" \
    , "Data/F_q_k=8.dat" u ( ( gamma_A*$1 + gamma_A*gamma_M*$2)/(gamma_A + gamma_M)):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w linespoints ls 8 lw 1.25 pt 6 dashtype 5 title "{/Symbol l}_{b}/{/Symbol l}_{u} = 2" \
    , "Data/F_q_k=16.dat" u ( ( gamma_A*$1 + gamma_A*gamma_M*$2)/(gamma_A + gamma_M)):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w linespoints ls 10 lw 1.25 pt 8 dashtype 1 title "{/Symbol l}_{b}/{/Symbol l}_{u} = 4" \
    , "Data/F_q_k=32.dat" u ( ( gamma_A*$1 + gamma_A*gamma_M*$2)/(gamma_A + gamma_M)):(1+$5/$4):(sqrt($6**2/$4**2+$5**2/$4**4*$7**2)) w linespoints ls 11 lw 1.25 pt 10 dashtype 7 title "{/Symbol l}_{b}/{/Symbol l}_{u} = 8"
